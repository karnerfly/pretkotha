...
const DashboardHome = () => {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${isDarkTheme ? "bg-gray-900 text-white" : "bg-gray-50 text-gray-800"} transition-colors duration-300`}>
      {/* Header */}
      <Header 
      ...
      <div className="flex-1 container mx-auto px-4 py-6 md:px-6 md:py-8 flex">
        ...
        {/* Main Area */}
        <main className={`flex-1 ml-0 md:ml-6 transition-all duration-300 ${isDarkTheme ? "text-white" : "text-gray-800"}`}>
          {/* Welcome Message */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className={`rounded-xl shadow-lg p-6 ${
              isDarkTheme ? "bg-gray-800 border border-gray-700" : "bg-white"
            } transition-colors duration-300 transform hover:scale-105 hover:shadow-xl`}>
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-gray-500 text-sm font-medium">Total Stories</p>
                  <h3 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mt-1">42</h3>
                </div>
              ...
              <div className="mt-4 flex items-center text-xs font-medium text-green-500">
                <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-13a1 1 0 10-2 0v.938a1 1 0 00.293.707l1.16 1.16a1 1 0 101.414-1.414l-.292-.293V5z" clipRule="evenodd" />
                </svg>
            ...
            <div className={`rounded-xl shadow-lg p-6 ${
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mt-1">1.2K</h3>
                </div>
            ...
            <div className={`rounded-xl shadow-lg p-6 ${
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h3 className="text-3xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mt-1">350</h3>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
            ...
            <div className={`lg:col-span-2 rounded-xl shadow-lg p-6 ${
              ...
              <div className="space-y-5">
                <div className="flex">
                  ...
                  <div>
                    <p className={`${isDarkTheme ? "text-gray-200" : "text-gray-700"} font-medium`}>You published a new story</p>
                ...
                <div className="flex">
                  ...
                  <div>
                    <p className={`${isDarkTheme ? "text-gray-200" : "text-gray-700"} font-medium`}>Your story got 50 new views</p>
                ...
                <div className="flex">
                  ...
                  <div>
                    <p className={`${isDarkTheme ? "text-gray-200" : "text-gray-700"} font-medium`}>Sarah liked your story</p>
            ...
            {/* Popular Stories */}
            <div className={`lg:col-span-3 rounded-xl shadow-lg p-6 ${
              isDarkTheme ? "bg-gray-800 border border-gray-700" : "bg-white"
            } transition-colors duration-300`}>
              <div className="flex justify-between items-center mb-4">
              ...
              <div className="space-y-4">
                <div className={`p-4 rounded-lg ${isDarkTheme ? "bg-gray-700" : "bg-gray-50"} flex items-center`}>
